...
train_transform.transforms.append(transforms.ColorJitter(brightness=0.05, contrast=0.05, saturation=0.05, hue=0.05))
...
print('loading the data cest ok')
...
for i in range(epoch):
    ...
    for c, x in enumerate(train_loader):
        ...
        if args['FMOnly']:
            ...
            loss =   loss1IM + loss2IM + loss1FM + loss2FM     #a1*loss_cls+ #on a aussi enleve a2 et a3 
